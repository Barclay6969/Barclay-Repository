...
# Validate that only addon.xml and kinoking.py changed before bytecode compilation.
changed=[]
...
# Syntax-check, then remove generated bytecode so the test ZIP stays clean.
